...
def tabbeddashboard():
    ...
    with tab1:
        ...
        def dashboard():
            ...
            active_user_data = parse_active_user_info(user_data)
            ...
            if user_data:
                ...
                if show_screenshots:
                    ...
                    # Load screenshots only when the checkbox is checked
                    screenshot_data = fetch_screenshots()
                    # Display screenshots...
                # Add a button to update the data
                st.sidebar.button("Update Data", on_click=fetch_user_data)
            ...
            time.sleep(60)
            parse_active_user_info(user_data)
...
def display_paginated_data(df, page_size=10):
...
# Use this function to display user data
display_paginated_data(pd.DataFrame(active_user_data))
