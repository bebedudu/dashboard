    ...
    # Dashboard Page
        ...
        if urgent:
            ...
            try:
                ...
                pass  # Prevent infinite loop on error
...
def _save_notifications():
    ...
    try:
        ...
        for _ in range(3):  # Retry up to 3 times
            ...
            st.error("Failed to get file SHA after 3 attempts")
            return
        ...
        if response.status_code == 409:
            st.error("Conflict detected - another update occurred. Please try again.")
            return
        response.raise_for_status()
        ...
        if "409" in str(e):
            st.session_state.show_notifications = False  # Prevent reload loop
        return
                    ...
                    if valid_notifications:
                        for idx, notification in valid_notifications:
                            ...
                            with col2:
                                ...
                                if st.button("Mark as Read", key=f"dismiss_{idx}"):
