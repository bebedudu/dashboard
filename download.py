# Count Files - Delete Files - Advanced Delete - Download Files
...
def download_files_advanced(folder, terminal_placeholder, start_date=None, end_date=None, num_files=None, unique_user_name=None):
    ...
    for file in filtered_files:
        ...
        # Download the file
        response = requests.get(file_url, headers={"Authorization": f"token {API_KEY}"})
        if response.status_code == 200:
...
def main():
    ...
    # Create tabs
    tab1, tab2, tab3, tab4 = st.tabs(["Count Files", "Delete Files", "Advanced Delete", "Download Files"])
